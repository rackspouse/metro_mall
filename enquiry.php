...
if($_POST['name']!="")
{
	if($_GET['EID']!="")
	{
		$upd = "update enquiry set gender = '".$_POST['gender']."',name = '".$_POST['name']."',contactno = '".$_POST['contact_no']."',country = '".$_POST['country']."',state = '".$_POST['state']."',city = '".$_POST['city']."',address = '".$_POST['address']."',email = '".$_POST['email']."',enquiry = '".$_POST['enquiry']."' where ID = '".$_GET['EID']."' ";
		mysql_query($upd) or die();	
	}
	else
	{
		$ins = "insert into enquiry set gender = '".$_POST['gender']."',name = '".$_POST['name']."',contactno = '".$_POST['contact_no']."',country = '".$_POST['country']."',state = '".$_POST['state']."',city = '".$_POST['city']."',address = '".$_POST['address']."',email = '".$_POST['email']."',enquiry = '".$_POST['enquiry']."' ";
...
<div class="outer">
	...
	<div class="three_enquiry">
	    <?php include('stack.php');?>
	
            <div class="right_enquiry">
            <form method="post" action="">
            	<div class="form">
                	<div class="form_heading">Enquiry
                    </div>
                    ...
                    <div>
                        ...
                        <div class="enquiry_box">
                        	<textarea name="enquiry" class="enquiry_box_in"></textarea>
                        </div>
                    </div>
